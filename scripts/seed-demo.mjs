...
const CATALOGUE = [
  ...
  { owner: 1, name: "Scientific calculator",  category: "Books & Study",   condition: "good",     price: 400,  pickup: "block-c-lobby",    days: 30, description: "Casio fx-991. Batteries new." },
  { owner: 1, name: "Monitor",                category: "Electronics",     condition: "good",     price: 1500, pickup: "block-c-lobby",    days: 14, description: "24 inch, HDMI. Cable included." },
  { owner: 1, name: "Desk chair",             category: "Furniture",       condition: "fair",     price: 0,    pickup: "block-c-lobby",    days: 9,  description: "One armrest is loose but it sits fine." },
  { owner: 1, name: "Kettle",                 category: "Kitchen",         condition: "good",     price: 0,    pickup: "block-c-lobby",    days: 16 },
  ...
  { owner: 2, name: "Organic chemistry textbook", category: "Books & Study", condition: "fair",  price: 300,  pickup: "library-entrance", days: 35, description: "Clarke, 8th edition. Some highlighting." },
